    ...
    const TodoList = todoList.length ? (
        ...
        <ul className="Todolist">
            {todoList.map((item, index) =>
                <li  className={item.completed ?"todo_list_item todo_list_item_done " :"todo_list_item"} key={item.id}>
                    <Todo
                      text={item.text}  />
                ...
                <span className="todo_list_button" onClick={()=>{markFavorite(index)}}>
...
//fix delete fontawsome V
// Mark the items as "Completed" + add completed class
// Mark the items as "Favorite" V
// Filter: Show All / Completed / Uncompleted / Favorite items V
